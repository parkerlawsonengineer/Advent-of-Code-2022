...
int main(int argc, char** argv) {
    ...
    while (getline(inputFile, readLine)) {
        ...
        if (newRange.doesFirstRangeContainSecond() ||
            newRange.doesSecondRangeContainFirst()) {
                total++;
            }

    }

    cout << "The total number of pairs where one range contains another is: " << total << "." << endl;
