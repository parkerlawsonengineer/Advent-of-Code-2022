...
class CPU {
    ...
    public:
        ...
        *   On each cycle, if the contents of register X are within 1 of the current 'pixel position' (current Cycle % 40)
        *   then a pixel is drawn into the display buffer.
        */
        void runCycle() {
            ...
            int pixelPos = this->cycleNumber - 1;
            if (pixelPos != 0 && pixelPos%40 == 0) {
                this->displayBuffer += "\n";
            }

            pixelPos = pixelPos%40;

            if (pixelPos >= this->registerX - 1 && pixelPos <= this->registerX + 1) {
                this->displayBuffer += "#";
            } else {
                this->displayBuffer += ".";
            }
        ...
        */
        ...
        /*
        *   Description: prints the contents of the display buffer created by runCycle() to the console.
        */
        void printDisplayBuffer() {
            cout << this->displayBuffer << endl;
        }
